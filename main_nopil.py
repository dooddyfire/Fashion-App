...
if __name__ == '__main__': 
    ...
    menu_frame.pack()
    btn = Button(menu_frame,text='Blazer Look',font=('Aerial 12 bold'),command=blaze_page,cursor='hand2')
    btn.pack(side=LEFT,padx=5)

    #img2 = ImageTk.PhotoImage(Image.open("assets/2.jpg").resize((150,150)))
    btn2 = Button(menu_frame,text='Y2K Look',font=('Aerial 12 bold'),command=y2k_page,cursor='hand2')
    btn2.pack(side=LEFT,padx=5)



    #img3 = ImageTk.PhotoImage(Image.open("assets/3.jpg").resize((150,150)))
    btn3 = Button(menu_frame,text='Head Scarf Look',font=('Aerial 12 bold'),command=headscaff_page,cursor='hand2')
    ...
    btn4 = Button(menu_frame2,text='Reference',font=('Aerial 12 bold'),command=reference_page,cursor='hand2')
    btn4.pack(side=LEFT,padx=5)

    #img5 = ImageTk.PhotoImage(Image.open("assets/exit.jpg").resize((150,150)))
    btn5 = Button(menu_frame2,text='Exit Program',font=('Aerial 12 bold'),command=exit_program,cursor='hand2')
